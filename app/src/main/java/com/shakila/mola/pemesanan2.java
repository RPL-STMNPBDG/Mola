    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputNama.getText().toString().length()==0) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(pemesanan2.this);
                    ...
                    Intent i = new Intent(pemesanan2.this, pembelian.class);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent bukamenu=new Intent(pemesanan2.this, mobildua.class);
